#!/bin/bash
# Created this script to solve the HackTheBox Challenge "Wild Goose Hunt".  This script takes advantage of a MongoDB NoSQL injection to brute force the admin password.
